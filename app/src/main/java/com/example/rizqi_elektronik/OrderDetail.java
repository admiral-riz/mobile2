        ...
        api.getOrderDetail(orderId).enqueue(new Callback<OrderDetailApiResponse>() {
            ...
            public void onResponse(Call<OrderDetailApiResponse> call, Response<OrderDetailApiResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null && response.body().getData() != null) {
                    ...
                    Toast.makeText(OrderDetail.this, "Gagal memuat detail pesanan", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
            ...
            public void onFailure(Call<OrderDetailApiResponse> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(OrderDetail.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }

    private void updateUI(OrderDetailResponse orderDetail) {
        ...
        api.uploadPaymentProof(orderIdBody, body).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()) {
                    Toast.makeText(OrderDetail.this, "Payment proof uploaded successfully", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(OrderDetail.this, OrderHistory.class);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(OrderDetail.this, "Failed to upload payment proof", Toast.LENGTH_SHORT).show();
                }
            }
