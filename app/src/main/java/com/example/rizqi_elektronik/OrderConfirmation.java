        ...
        api.uploadPaymentProof(orderIdBody, body).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()) {
                    Toast.makeText(OrderConfirmation.this, "Payment proof uploaded successfully", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(OrderConfirmation.this, OrderHistory.class);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(OrderConfirmation.this, "Failed to upload payment proof", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(OrderConfirmation.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}