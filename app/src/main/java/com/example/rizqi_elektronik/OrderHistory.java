    ...
    private void loadOrderHistory() {
        ...
        api.getOrderHistory(email).enqueue(new Callback<OrderResponse>() {
            ...
            public void onResponse(Call<OrderResponse> call, Response<OrderResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (orderResponse.isSuccess()) {
                        ...
                        Toast.makeText(OrderHistory.this, orderResponse.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                } else {
            ...
            public void onFailure(Call<OrderResponse> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(OrderHistory.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
